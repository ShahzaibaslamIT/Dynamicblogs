...
return()=>clearInterval(interValid)
    ...
    return(
       <header className="text-black body-font-shadow-lg w-full">

        <div className="container mx-auto flex flex-wrap p-2 flex-col md:flex-row items-center">
            <div className="flex-1 text-white bg-black ml-[10px]">
        ...
        <button className="inline-flex items-center bg-red-700 border-0 py-1 px-3 focus:outline-none hover:bg-red-700 rounded text-white mt-4 md:mt-0 transition-colors duration-300 ml-[350px] mt-[300px]">
            Youtube
            <svg
            fill='none'
            stroke='currentColor'
